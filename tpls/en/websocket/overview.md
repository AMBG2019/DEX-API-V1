...
``
mainnet: wss://ws.api3.ambging.io/v3/ws
testnet(goerli): wss://ws.uat3.ambging.io/v3/ws
```
...
2. Use `fx2xW5hoVFbcaanWS` as a wsApiKey param in ws path, i.e., wss://ws.uat3.ambging.io/v3/ws?wsApiKey=fx2xW5hoVFbcaanWS.
